...
class Individual:
    ...
    def generate(self, id):
        ...
        status = random.choice(list(ID.mstatusdf.columns)[2:])
        return Person(id, age=age, sex=sex, ethnicity=ethnicity, religion=religion, status=status)

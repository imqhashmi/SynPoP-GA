...
CROSS_TABLES['sex_age_status'] = {'M 24* Single': 105, 'M 24* Married': 3, 'M 24* Partner': 0, 'M 24* Seperated': 0, 'M 24* Divorced': 0, 'M 24* Widowed': 0, 'M 25-34 Single': 203, 'M 25-34 Married': 100, 'M 25-34 Partner': 0, 'M 25-34 Seperated': 3, 'M 25-34 Divorced': 3, 'M 25-34 Widowed': 1, 'M 35-49 Single': 150, 'M 35-49 Married': 217, 'M 35-49 Partner': 0, 'M 35-49 Seperated': 13, 'M 35-49 Divorced': 27, 'M 35-49 Widowed': 3, 'M 50-64 Single': 46, 'M 50-64 Married': 160, 'M 50-64 Partner': 0, 'M 50-64 Seperated': 11, 'M 50-64 Divorced': 35, 'M 50-64 Widowed': 7, 'M 65+ Single': 32, 'M 65+ Married': 126, 'M 65+ Partner': 2, 'M 65+ Seperated': 2, 'M 65+ Divorced': 29, 'M 65+ Widowed': 48, 'F 24* Single': 175, 'F 24* Married': 2, 'F 24* Partner': 0, 'F 24* Seperated': 2, 'F 24* Divorced': 0, 'F 24* Widowed': 0, 'F 25-34 Single': 197, 'F 25-34 Married': 50, 'F 25-34 Partner': 3, 'F 25-34 Seperated': 10, 'F 25-34 Divorced': 15, 'F 25-34 Widowed': 0, 'F 35-49 Single': 127, 'F 35-49 Married': 68, 'F 35-49 Partner': 0, 'F 35-49 Seperated': 34, 'F 35-49 Divorced': 54, 'F 35-49 Widowed': 6, 'F 50-64 Single': 35, 'F 50-64 Married': 46, 'F 50-64 Partner': 1, 'F 50-64 Seperated': 17, 'F 50-64 Divorced': 68, 'F 50-64 Widowed': 25, 'F 65+ Single': 28, 'F 65+ Married': 36, 'F 65+ Partner': 1, 'F 65+ Seperated': 2, 'F 65+ Divorced': 39, 'F 65+ Widowed': 160}
...
def random_person():
    ...
    return {'age': age, 'sex': sex, 'status': status}
...
def random_individual():
    ...
    comb = [(age[i], sex[i], status[i]) for i in range(0,Total)]
    individual = [{'age':c[0], 'sex':c[1], 'status': c[2]} for c in comb]
...
# fit = toolbox.evaluate(population[0])

...
#     fitness_sex_age_ethnicity = getfitness(individual, 'sex_age_ethnicity')
#
...
#     return {'age': age, 'sex': sex, 'ethnicity': ethnicity, 'religion': religion,
#             'status': status, 'qualification': qual}
#
# def validate(individual):
#     for ind in individual:
#         print(ind['age'], ind['status'])
#
...
#     individual = [{'age':c[0], 'sex':c[1], 'ethnicity':c[2], 'religion':c[3],
...
# # plot(CROSS_TABLES['sex_age_religion'], getStats(best_individual, 'sex_age_religion'), 'sex_age_religion', width=5000)
